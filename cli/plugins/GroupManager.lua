...
elseif lang then
 return "》ارسال #لینک در گروه  از قبلا ممنوع است🔒\n*🚫〰〰〰〰〰〰🚫*\nسفارش توسط : [@"..check_markdown(msg.from.username or "").."]"
end
else
...
if not lang then
 ...
 return "نوشته انگلیسی در گروه ممنوع شد🔒\n*〰〰〰〰〰〰〰〰*\nسفارش توسط : [@"..check_markdown(msg.from.username or "Arashwm").."]"
end
end
end
...
if not lang then
return "*#eиglłšħ* _ρøšтłиg ħαš вeeи υиlø¢κeđ_🔓\n*✅〰〰〰〰〰〰✅*\n*øяđeявч*: [@"..check_markdown(msg.from.username or "Arashwm").."]" 
else
    ...
    if matches[1] == 'del' and is_mod(msg) or matches[1] == 'Del' and is_mod(msg) or matches[1] == 'rmsg' and is_mod(msg) or matches[1] == 'Rmsg' and is_mod(msg) or matches[1] == 'حذف' and is_mod(msg) then
        if tostring(msg.to.id):match("^-100") then 
            if tonumber(matches[2]) > 1000 or tonumber(matches[2]) < 1 then
                return  '🚫 *10000*> _تعداد پیام های قابل پاک سازی در هر دفعه_ >*1* 🚫'
            else
...
🔘تایین ادمین گروه در صورتی که ربات صاحب گروه باشد
➢Config➢
⚜تنظیم مالک گروه و ترفیع تمام مدیران گروه 
⌨️ ℓαηgυαgє вσт єηgℓιѕн !
To Change The LanGuage 
Setlang [en , fa]
➖➖➖
...
To Change The LanGuage [Setlang] [en , fa]
➖➖➖
👤 ρσωєяɗ Ɓу : ارش
🗣 ƇнαηηєƖ : 💚❤
 ]]
...
{لینک ➢، یوزرنیم ➢، هشتگ ➢، فراخوانی ➢، اسپم ➢، حساسیت ➢، ویرایش ➢، ربات ➢، مارکدون ➢، وب ➢، سنجاق ➢، انگلیسی ➢، عربی ➢، ویو ➢، امجو ➢، تبلیغات ➢، فحش➢،دستورات➢،ورود}
⌨️ زبان ربات فارسی !
برای تغییر زبان [تنظیم زبان] [فارسی , انگلسیی]
➖➖➖
👤 ρσωєяɗ Ɓу : ارش
🗣 ƇнαηηєƖ : ❤💙
]]
